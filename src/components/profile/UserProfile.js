  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  ></textarea>
                  <p className="mt-1 text-xs text-gray-500">Brève description de vous-même</p>
                </div>
                ...
                <div className="mt-5 border-t border-gray-200">
                  <dl className="divide-y divide-gray-200">
                    <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                      ...
                      <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{currentUser?.name || 'Non défini'}</dd>
                    </div>
                    <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                      <dt className="text-sm font-medium text-gray-500">Adresse email</dt>
                      <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{currentUser?.email || 'Non défini'}</dd>
                    </div>
                    <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                      <dt className="text-sm font-medium text-gray-500">Biographie</dt>
                      <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{bio || 'Aucune biographie fournie'}</dd>
                    </div>
                  </dl>
                </div>
              </div>
      ...
      <div className="mt-8 bg-white shadow rounded-lg overflow-hidden">
        ...
        <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
          <p className="text-gray-500 text-center py-4">Aucune contribution pour le moment.</p>
        </div>
      </div>
    </div>
  );
